...
namespace BikerRental.Web
{
    public class TourController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Type,Name,Image,Description,Duration,Schedules,Address1,Address2,DepartureTime,ContactNumber,Notice,OnlinePrice,OnstatePrice,Enabled,RightPanel,HomePage,FrontPage")] Tour tour)
        {
